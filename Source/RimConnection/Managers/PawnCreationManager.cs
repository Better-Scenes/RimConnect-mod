...
namespace RimConnection
{
    class PawnCreationManager
    {
        ...
        private static List<Trait> badTraits = new List<Trait>(new Trait[] {
            new Trait(DefDatabase<TraitDef>.GetNamed("Beauty"), -2),
            new Trait(DefDatabase<TraitDef>.GetNamed("NaturalMood"), -2),
            new Trait(DefDatabase<TraitDef>.GetNamed("Nerves"), -2),
            new Trait(TraitDefOf.Industriousness, -2),
            new Trait(DefDatabase<TraitDef>.GetNamed("Beauty"), -1),
            new Trait(DefDatabase<TraitDef>.GetNamed("NaturalMood"), -1),
            new Trait(DefDatabase<TraitDef>.GetNamed("Nerves"), -1),
            new Trait(TraitDefOf.Industriousness, -1),
            new Trait(DefDatabase<TraitDef>.GetNamed("SpeedOffset"), -1),
        ...
        private static List<Trait> goodTraits = new List<Trait>(new Trait[] {
            ...
            new Trait(DefDatabase<TraitDef>.GetNamed("Nerves"), 2),
            new Trait(TraitDefOf.Industriousness, 2),
            new Trait(DefDatabase<TraitDef>.GetNamed("SpeedOffset"), 2),
            new Trait(DefDatabase<TraitDef>.GetNamed("Cannibal")),
            new Trait(TraitDefOf.GreatMemory),
            new Trait(DefDatabase<TraitDef>.GetNamed("Tough")),
            new Trait(DefDatabase<TraitDef>.GetNamed("Immunity"), 1),
